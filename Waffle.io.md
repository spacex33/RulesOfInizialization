[Waffle.io](http://waffle.io) - канбан-доска для планирования задач и разделения их на группы. Интегрирован с GitHub. Позволяет визуализировать текущее состояние выполнения задач.
